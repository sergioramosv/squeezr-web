...
const sections = [
  {
    ...
    items: [
      { title: "Installation", href: "/docs/installation", desc: "Install Squeezr globally via npm in under a minute" },
      { title: "Setup", href: "/docs/setup", desc: "Configure your AI tool to route through the proxy" },
      { title: "Quick Start", href: "/docs/quick-start", desc: "Three commands to get up and running" },
    ],
  },
  {
    title: "Tool Guides",
    ...
    items: [
      { title: "Claude Code", href: "/docs/claude-code", desc: "System prompt compression, tool dedup, OAuth support" },
      { title: "OpenAI Codex", href: "/docs/codex", desc: "Chat completions format, local model routing" },
      { title: "Aider", href: "/docs/aider", desc: "API base config, file content compression" },
      { title: "Gemini CLI", href: "/docs/gemini-cli", desc: "Google API format, streaming, key handling" },
      { title: "Ollama & LM Studio", href: "/docs/ollama", desc: "Local models, custom upstream, compression model" },
      { title: "Configuration", href: "/docs/configuration", desc: "Full TOML config guide with all options" },
    ],
  },
  {
    title: "How it Works",
    ...
    items: [
      { title: "Compression Pipeline", href: "/docs/compression-pipeline", desc: "The 7-layer pipeline explained step by step" },
      { title: "Patterns", href: "/docs/patterns", desc: "30+ deterministic patterns for git, tests, builds, infra" },
      { title: "Caching", href: "/docs/caching", desc: "Session cache, compression cache, KV warming" },
    ],
  },
  {
    title: "Reference",
    ...
    items: [
      { title: "CLI Commands", href: "/docs/cli-commands", desc: "setup, start, stop, status, logs" },
      { title: "Config File", href: "/docs/config-file", desc: "Complete squeezr.toml reference" },
      { title: "API Endpoints", href: "/docs/api-endpoints", desc: "Health, stats, expand, proxy routes" },
      { title: "Expand Tool", href: "/docs/expand-tool", desc: "How squeezr_expand() works and its formats" },
    ],
  },
];
