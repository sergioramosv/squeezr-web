...
export function CTASection() {
  const { t } = useI18n();
  const badges = [
    { text: t.cta.badges.mit, color: "text-blue-700 dark:text-blue-500", bg: "bg-blue-50 dark:bg-blue-500/10", border: "border-blue-200 dark:border-blue-500/20" },
    { text: t.cta.badges.zero, color: "text-green-700 dark:text-green-600", bg: "bg-green-50 dark:bg-green-600/10", border: "border-green-200 dark:border-green-600/20" },
    { text: t.cta.badges.setup, color: "text-orange-700 dark:text-orange-600", bg: "bg-orange-50 dark:bg-orange-600/10", border: "border-orange-200 dark:border-orange-600/20" },
  ];
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <ScrollReveal delay={0.25}>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <Link href="/docs/installation" className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl transition-all text-sm hover:-translate-y-0.5">
              {t.cta.readDocs}
            </Link>
        ...
        <ScrollReveal delay={0.35}>
          <div className="flex justify-center gap-3 flex-wrap">
            {badges.map((b) => (
              <motion.span
                key={b.text}
                className={`px-3 py-1.5 rounded-full text-xs font-medium ${b.color} ${b.bg} border ${b.border}`}
